    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.pizzaWrapperLeft}> 
              <Image src={pizza.image} alt={pizza.name} className={styles.pizzaImage }  height={600} width={600}/>
                        ...
                        return(
                            <div className={styles.otherPizza} key={otherPizza.id}>
                             <Link href={"/" + otherPizza.slug}><a>
                              <Image src={otherPizza.image} alt={otherPizza.name} height={200} width={200}  />
                              <p>{otherPizza.name}</p>
                             </a></Link>
                            </div>
                        )
